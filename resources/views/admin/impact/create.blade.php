...
{{ Form::open(['route' => 'impacts.store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation']) }}
    ...
    <div class="col-md mb-4 mb-md-0">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        @include('admin.includes.form.select', ['label' => __('site.cases'), 'options' => $caseArr, 'fieldName' => 'case_id', 'class' => 'select2 form-select', 'required' => true])
                        @error('case_id')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
