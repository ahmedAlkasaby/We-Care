        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            <div id="wizard-validation" class="bs-stepper wizard-validation mt-2">
                ...
                <div class="bs-stepper-content">
                    ...
                    {!! Form::model($case,['route' => ['cases.update', $case->id], 'method' => 'put', 'enctype'=>'multipart/form-data', 'id' => 'wizard-validation-form']) !!}
...
<script src="{{ url("js/editRepeater.js") }}"></script>
<script src="{{ url("js/editCase.js") }}"></script>
@endsection
