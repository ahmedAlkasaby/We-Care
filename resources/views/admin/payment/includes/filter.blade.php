<div class="card-header d-flex flex-wrap py-0 flex-column flex-sm-row justify-content-between mt-4 mb-4">
    <div class="me-5 ms-n2 pe-5">
        <div class="dataTables_filter">
            <form action="{{ route('payments.index') }}" method="get" class="d-flex align-items-center">
    ...
    <div class="d-flex justify-content-end">
        @if (auth()->user()->hasPermission('payments.store'))
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEcommercePaymentList">

            <span>
                <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                <span class="d-none d-sm-inline-block">@lang('site.add_payment')</span>
            </span>
        </button>
        @else
