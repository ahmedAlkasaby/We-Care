<div class="modal fade" id="adminsForm" tabindex="-1" aria-labelledby="adminLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content p-3 p-md-4">
            <div class="modal-header py-4">
                <h5 class="modal-title" id="adminLabel">@lang('site.admin')</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body border-top">
                {!! Form::open([ 'id' => 'admins', 'class' => 'row g-3', 'enctype' => 'multipart/form-data']) !!}
                ...
                <input type="hidden" id="operationType" name="operationType">
                    ...
                    <div class="col-12">
                        @include('admin.includes.form.text', ['label' => __('site.admin phone'), 'fieldName' => 'phone', 'id'=>'phone','fieldValue' => null, 'place' => __('site.admin phone')])
                    </div>
                    ...
                    <div class="col-12">
                        @include('admin.includes.form.select', ['label' => __('site.role'), 'fieldName' => 'role_id','id'=>'role_id', 'options' => $roles->pluck('name', 'id'), 'fieldValue' => null, 'class' => 'form-select select2', 'required' => true])
                    </div>
