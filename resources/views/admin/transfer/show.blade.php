                ...
                <div class="card-body">
                    <div class="row p-sm-3 p-0">
                        <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
                            ...
                            <p class="mb-1"><strong>@lang('site.address')</strong> : {{$city->nameLang()}} :
                                {{$region->nameLang()}}</p>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="fw-medium">${{$transfer->price}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="ps-2 py-4">
                                    <p class="fw-medium mb-0 pb-3">${{ $transfer->price }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="javascript:window.print()"
                        class="btn btn-primary d-grid w-100 mb-2 waves-effect waves-light">Print</a>
                </div>
            </div>
        </div>
        <!-- /Invoice Actions -->
