<div class="card-header d-flex flex-wrap py-0 flex-column flex-sm-row justify-content-between mt-4 mb-4">
    <div class="me-5 ms-n2 pe-5">
        <div class="dataTables_filter">
            <form action="{{ route('category_cases.index') }}" method="get" class="d-flex align-items-center">
    ...
    @if (auth()->user()->hasPermission('category_cases.store'))
    <button class="btn btn-secondary add-new btn-primary ms-2 waves-effect waves-light" data-bs-toggle="modal"
        data-bs-target="#categoriesCaseForm">
        <span>
            <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
            <span class="d-none d-sm-inline-block">@lang('site.add_category_case')</span>
        </span>
    </button>
    @else
